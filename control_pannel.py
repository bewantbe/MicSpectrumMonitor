...
class Ui_Dock4(object):
    def setupUi(self, Dock4):
        ...
        self.comboBox_fftlen = QtWidgets.QComboBox(parent=self.gridLayoutWidget)
        self.comboBox_fftlen.setEditable(False)
        self.comboBox_fftlen.setObjectName("comboBox_fftlen")
        self.comboBox_fftlen.addItem("")
        self.comboBox_fftlen.addItem("")
        self.comboBox_fftlen.addItem("")
        self.comboBox_fftlen.addItem("")
        self.comboBox_fftlen.addItem("")
        self.comboBox_fftlen.addItem("")
        self.gridLayout.addWidget(self.comboBox_fftlen, 0, 6, 1, 1)
        ...
        Dock4.setTabOrder(self.lineEdit_ch, self.comboBox_fftlen)
        Dock4.setTabOrder(self.comboBox_fftlen, self.comboBox_nave)
    ...
    def retranslateUi(self, Dock4):
        ...
        self.comboBox_fftlen.setCurrentText(_translate("Dock4", "1024"))
        self.comboBox_fftlen.setItemText(0, _translate("Dock4", "1024"))
        self.comboBox_fftlen.setItemText(1, _translate("Dock4", "2048"))
        self.comboBox_fftlen.setItemText(2, _translate("Dock4", "4096"))
        self.comboBox_fftlen.setItemText(3, _translate("Dock4", "8192"))
        self.comboBox_fftlen.setItemText(4, _translate("Dock4", "16384"))
        self.comboBox_fftlen.setItemText(5, _translate("Dock4", "32768"))
